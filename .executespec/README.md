# `.executespec/` — for `navneetprabhakar/montecarlo`

> Generated by ExecuteSpec on `2026-07-31T14:37:50.201305Z`.
...
| `config/repro-montecarlo-1785508666/*.yaml` | no | Customer-authored config; ExecuteSpec only proposes additions |
...
`config/repro-montecarlo-1785508666/standards.yaml`,
